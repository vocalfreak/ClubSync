...
- `EXTRACTION_IMPLEMENTATION_PLAN.md` — Phase 3 companion. **2026-09-24:** in-extraction CSRW guard (§6/§6.1) and prompt v3 wording (recap-wins + `qr_code_seen` precision) decided and built.
